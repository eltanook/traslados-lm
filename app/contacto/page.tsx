  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        "https://formsubmit.co/traslados.mensajeria@gmail.com",
        {
          method: "POST",
          headers: {
      ...
      alert(
        "Error al enviar el mensaje. Por favor, intenta nuevamente o contactanos directamente por WhatsApp."
      );
    }
  };
    ...
    <div className="min-h-screen bg-background py-8 sm:py-12">
      <div className="container mx-auto px-4">
            ...
            <Card className="h-full">
              ...
              <CardContent className="flex-1">
                ...
                >
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-brand-orange hover:bg-brand-orange/90 text-white mt-auto"
                  >
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm sm:text-base break-all">
                      traslados.mensajeria@gmail.com
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm sm:text-base">
                      C. 178 6158, B1903EGJ Melchor Romero, Provincia de Buenos Aires
                    </p>
                  </div>
                </div>
        ...
        <Card className="mt-6 sm:mt-8">
          ...
          <CardContent>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1943.9835641125533!2d-58.036878779030154!3d-34.972204886789974!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95a2c3a5f2d529d7%3A0x29366124c283aed1!2sTraslados%20La%20Plata%20Ezeiza!5e0!3m2!1ses!2sar!4v1753465041232!5m2!1ses!2sar"
              width="100%"
              height="300"
              style={{ border: 0 }}
              allowFullScreen
